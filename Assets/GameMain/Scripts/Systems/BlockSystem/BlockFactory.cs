...
namespace OasisProject3D.BlockSystem {
    ...
    public partial class BlockFactory : IEntityFactory<BlockCtrl> {
        ...
        public QuickRandom BlockRandom;
        private QuickRandom MapRandom => GamePlayEnter.MapMgr.Random;
        ...
        public void Init() {
            ...
            _steepParameter = GamePlayEnter.MapMgr.MapGenerateConfig.steepParameter;
            BlockRandom = new QuickRandom();
            BlockConf = BlockMgr.BlockConf;
        ...
        private BlockCtrl AddBlockBase(Vector2Int logicalPos) {
            ...
            output.height = MapRandom.Noise.GetNoise(logicalPos.x, logicalPos.y) * _steepParameter;
        ...
        private void AddBlockType(BlockCtrl blockCtrl, EBlockType blockType) {
            ...
            blockCtrl.greenRate = MapRandom.GetFloat(vcRange.x, vcRange.y);
