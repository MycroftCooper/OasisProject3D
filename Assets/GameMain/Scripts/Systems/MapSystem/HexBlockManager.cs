...
namespace OasisProject3D.HexBlockSystem {
    public class HexBlockManager {
        public enum BlockType { Desert, Gobi, Oasis };
        public Vector2Int MapSize;
        public HexBlockLogic[][] Map;
        public float DesertRate = 0.2f;
        public float GobiRate = 0.4f;
        public float OasisRate = 0.4f;
        public int MixingAreaSize = 2;
