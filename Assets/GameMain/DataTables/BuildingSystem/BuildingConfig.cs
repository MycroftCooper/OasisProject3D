...
public sealed partial class BuildingConfig :  Bright.Config.BeanBase 
{
    public BuildingConfig(JSONNode _json) 
    {
        ...
        { var _json1 = _json["canBulidBlockType"]; if(!_json1.IsArray) { throw new SerializationException(); } int _n = _json1.Count; CanBulidBlockType = new EBlockType[_n]; int _index=0; foreach(JSONNode __e in _json1.Children) { EBlockType __v;  { if(!__e.IsNumber) { throw new SerializationException(); }  __v = (EBlockType)__e.AsInt; }  CanBulidBlockType[_index++] = __v; }   }
        { if(!_json["HP"].IsNumber) { throw new SerializationException(); }  HP = _json["HP"]; }
        { var _json1 = _json["bulidCost"]; if(!_json1.IsArray) { throw new SerializationException(); } BulidCost = new System.Collections.Generic.Dictionary<EResType, int>(_json1.Count); foreach(JSONNode __e in _json1.Children) { EResType __k;  { if(!__e[0].IsNumber) { throw new SerializationException(); }  __k = (EResType)__e[0].AsInt; } int __v;  { if(!__e[1].IsNumber) { throw new SerializationException(); }  __v = __e[1]; }  BulidCost.Add(__k, __v); }   }
        { var _json1 = _json["keepCost"]; if(!_json1.IsArray) { throw new SerializationException(); } KeepCost = new System.Collections.Generic.Dictionary<EResType, int>(_json1.Count); foreach(JSONNode __e in _json1.Children) { EResType __k;  { if(!__e[0].IsNumber) { throw new SerializationException(); }  __k = (EResType)__e[0].AsInt; } int __v;  { if(!__e[1].IsNumber) { throw new SerializationException(); }  __v = __e[1]; }  KeepCost.Add(__k, __v); }   }
        { var _json1 = _json["produce"]; if(!_json1.IsArray) { throw new SerializationException(); } Produce = new System.Collections.Generic.Dictionary<EResType, int>(_json1.Count); foreach(JSONNode __e in _json1.Children) { EResType __k;  { if(!__e[0].IsNumber) { throw new SerializationException(); }  __k = (EResType)__e[0].AsInt; } int __v;  { if(!__e[1].IsNumber) { throw new SerializationException(); }  __v = __e[1]; }  Produce.Add(__k, __v); }   }
        { var _json1 = _json["storage"]; if(!_json1.IsArray) { throw new SerializationException(); } Storage = new System.Collections.Generic.Dictionary<EResType, int>(_json1.Count); foreach(JSONNode __e in _json1.Children) { EResType __k;  { if(!__e[0].IsNumber) { throw new SerializationException(); }  __k = (EResType)__e[0].AsInt; } int __v;  { if(!__e[1].IsNumber) { throw new SerializationException(); }  __v = __e[1]; }  Storage.Add(__k, __v); }   }
