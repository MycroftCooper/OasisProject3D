...
namespace Medium.FGUI
{
    ...
    public static class UIControlBinding
    {
        ...
        public static void BindFields(object obj, GObject root)
        {
            ...
            Reflect.GetFields(objType, flags, true, ref fields, _canBindFunc);
            ...
            for (int i = 0; i < fields.Count; i++)
            {
                ...
                {
                    //if (control.data is string data)
                    //{
                    //    data.To(ref dataDic);
                    //    if (control.filter == null && dataDic.TryGetValue(LeiSheTag, out var assetPath))
                    //    {
                    //        control.SetCustomFilter(assetPath);
                    //    }
                    //}
        ...
        private static Func<FieldInfo, bool> _canBindFunc = CanBind;
        ...
        //public static void SetCustomFilter(this GObject gObj, string assetPath)
        //{
        //    if (gObj == null)
        //        return;
        //    gObj.filter = new CustomFilter();

        //    AssetLoaderEx.LoadAsset(assetPath, (str, obj, data) =>
        //    {
        //        if (gObj == null)
        //            return;
        ...
        //            return;
        //        }
        //        var extMatPreset = go.GetComponent<FGUIExtMatPreset>();
        //        if (extMatPreset == null)
        //        {
        //            gObj.filter = null;
        //            return;
        //        }

        //        var filter = gObj.filter;
        //        (filter as CustomFilter)?.SetData(false, extMatPreset.mats);
        //    });
        //}

        //public static void SetCustomFilter(this GObject gObj, bool shoudDestroyMatOnDispos, params UnityEngine.Material[] mats)
        //{
        //    if (gObj == null)
        //        return;
        //    var filter = new CustomFilter(shoudDestroyMatOnDispos, mats);
        //    gObj.filter = filter;
        //}
    }
}
